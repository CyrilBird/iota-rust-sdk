...
mod serialization {
    ...
    mod test {
        ...
        fn signed_checkpoint_fixture() {
            // Checkpoint summary of a "normal" checkpoint and end of epoch checkpoint, so
            // last checkpoint of an epoch
            // http://localhost:9000/api/v1/checkpoints to find the latest checkpoint of an epoch
            // To get the summar as base64, use:
